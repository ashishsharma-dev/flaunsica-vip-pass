...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function drawPassFooter(ctx) {
    ...
    ctx.textAlign = 'center';
    ctx.fillText('curated by Prestha Agarwal • 55+ Premier Luxury Designer Brands', 600, 680);
    ctx.textAlign = 'left';
  }
  ...
  btnShareWhatsApp.addEventListener('click', () => {
    const shareText = `Hey! I just got my VIP Pass for *Flaunsica Hyderabad – 10th Refined Edition* (23 Sept 2026 at Park Hyatt). 55+ luxury designer brands under one roof! curated by Prestha Agarwal. Get your complimentary VIP pass here: https://flaunsica.com`;
